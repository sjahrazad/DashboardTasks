		...
		<div>
			<details>
				...
				<ul>
					...
					<li>MD Collabs Owner (Hi <strong><?php echo $user->name; ?></strong>, you are belong to this group)</li>
					<li>MD Collabs Coworker</li>
				</ul>
				</p>
				<p><strong>MD Collabs Owner</strong>: The user who has the right to submit a Job in MD Collabs Scheduler.</p>
			</details>
		</div>
		<div>
			<details>
