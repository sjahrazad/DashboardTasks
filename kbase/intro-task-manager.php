	...
	<main id="task-main" class="task-main">
		<div>
			<details>
				...
				<ul>
					<li>MD Collabs Manager (Hi <strong><?php echo $user->name; ?></strong>, you are belong to this group)</li>
					<li>MD Collabs Owner</li>
					<li>MD Collabs Coworker</li>
				</ul>
				</p>
				<p><strong>MD Collabs Manager</strong>: A supervisor of the MD Collabss Group. The MD Collabs Manager will manage Case Status, Priority, MD Collabs Lock /Unlock, Trash and Delete.</p>
			</details>
		</div>
		<div>
			<details>
